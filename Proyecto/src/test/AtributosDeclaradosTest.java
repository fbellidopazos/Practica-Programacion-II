			...
			try {
				...
				if (attrSpecialization[i]!=null){
					if (((ParameterizedType)atributo.getGenericType()).getActualTypeArguments()==null ||
						...
						fail("Debe declarar el atributo "+attrNames[i]+" de tipo "+attrTypes[i]+" y su tipo de par�metro debe ser "+attrSpecialization[i]+" en la clase "+className);
					}
					assertEquals("Debe declarar el atributo "+attrNames[i]+" de tipo "+attrTypes[i]+" y su tipo de par�"
