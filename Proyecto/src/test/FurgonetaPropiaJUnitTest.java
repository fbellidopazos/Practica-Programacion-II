...
public class FurgonetaPropiaJUnitTest {
	...
	@Rule //Se establece un time out general para todos los tests. Se debe comentar esta l�nea y la de abajo para depurar
    public TestRule  globalTimeout = new DisableOnDebug(Timeout.millis(100)); // 100 milisegundos m�ximos por test	
	 ...
	 * 
	 * <p>Utiliza los m�todos getTara y getCodigo.</p>
	 */
	@Test
